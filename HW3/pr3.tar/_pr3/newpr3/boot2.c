...
int main()
{
    ...
    int retVal = create_process((int) process_idle);
    numProcesses++;
    ...
    create_process((int) p5);
    numProcesses++;
    create_process((int) p4);
    numProcesses++;
    create_process((int) p3);
    numProcesses++;
    create_process((int) p2);
    numProcesses++;
    create_process((int) p1);
    numProcesses++;
    //end loop
